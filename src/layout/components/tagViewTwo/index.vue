...
<script>
import ScrollPane from "../tagView/scollbar"
export default {
    name:"TagView",
    components:{
        ScrollPane
    ...
    methods:{
        ...
        // 页面初始化获取标签
        generateRoute(){
            if(this.$route.meta.hasOwnProperty("activeMenu")){
                return false;
            }
            if (this.$route.name) {
              return this.$route
        ...
        addViewTags() {
            ...
            // if(route.meta.hasOwnProperty("activeMenu")){
            //     return false;
            // }
        ...
        isActive(route) {
            if(this.$route.meta.hasOwnProperty("activeMenu")){
                return route.path === this.$route.meta.activeMenu
            }
